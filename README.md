...
# ۷. (پیشنهادشده) اجرای مجموعه‌تست‌های خودکار — ۱۰۳ تست، بدونِ دست‌زدن به دیتابیسِ اصلی
