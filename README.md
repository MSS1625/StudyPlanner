...
# ۷. (پیشنهادشده) اجرای مجموعه‌تست‌های خودکار — ۱۸۵ تست، بدونِ دست‌زدن به دیتابیسِ اصلی
...
python manage.py test planner     # ۱۸۵ تست — این‌بار روی PostgreSQL
```
