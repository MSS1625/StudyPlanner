...
# ۷. (پیشنهادشده) اجرای مجموعه‌تست‌های خودکار — ۲۴۶ تست، بدونِ دست‌زدن به دیتابیسِ اصلی
python manage.py test planner
...
python manage.py test planner     # ۲۴۶ تست — این‌بار روی PostgreSQL
```
