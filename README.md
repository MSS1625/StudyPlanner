...
| `GET` | `/api/auth/security/events/` | تاریخچه‌ی رویدادهایِ امنیتیِ حسابِ کاربرِ لاگین‌شده — ورودِ موفق/ناموفق، تغییر/بازنشانیِ رمز با زمان، IP و مرورگر (`?limit=` اختیاری؛ برچسب‌ها fa/en با Accept-Language) (از 2026-09-12) |
...
# ۷. (پیشنهادشده) اجرای مجموعه‌تست‌های خودکار — ۲۷۵ تست، بدونِ دست‌زدن به دیتابیسِ اصلی
...
python manage.py test planner     # ۲۷۵ تست — این‌بار روی PostgreSQL
```
