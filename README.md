...
9. **مجموعه‌تستِ خودکار**: ۶۲ تستِ Django/DRF در `backend/planner/tests.py` (احراز هویت، CRUD درس/امتحان/گزارش، سناریوهای امنیتیِ جداسازی کاربران، برنامه‌ریز، داشبورد و تستِ واحدِ الگوریتم) — اجرا با `python manage.py test planner`.
