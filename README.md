...
# ۷. (پیشنهادشده) اجرای مجموعه‌تست‌های خودکار — ۲۱۴ تست، بدونِ دست‌زدن به دیتابیسِ اصلی
...
python manage.py test planner     # ۲۱۴ تست — این‌بار روی PostgreSQL
```
