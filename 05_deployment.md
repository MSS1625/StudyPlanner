...
| ۵.۱۳ | ورودِ دومرحله‌ای و ساعتِ سرور (NTP) |
...
## ۵.۱۳ ورودِ دومرحله‌ای و ساعتِ سرور (از 2026-09-14)

کدِ TOTP بر مبنایِ «زمانِ یونیکسِ» سرور و اپلیکیشنِ احرازگرِ کاربر ساخته می‌شود؛ پنجره‌ی ±۱ گام (±۳۰ ثانیه) خطایِ عادیِ ساعت را می‌بخشد. برایِ Production حتماً **NTP را رویِ سرور فعال نگه دارید** (`timedatectl` باید `System clock synchronized: yes` نشان بدهد) — ساعتِ منحرفِ بیشتر از ~۹۰ ثانیه یعنی هیچ کدی پذیرفته نمی‌شود و کاربرانِ 2FAدار بی‌دلیل بیرون می‌مانند (رمزِ درست + ۴۰۱ِ پی‌درپیِ کد). نکته‌ی بازیابی: کاربرِ 2FAداری که گوشی‌اش را گم کرده، با همانِ جریانِ بازیابیِ رمز (بخشِ ۵.۱۲) به حساب برمی‌گردد — بازنشانیِ موفق، ورودِ دومرحله‌ای را هم خاموش می‌کند و دو ایمیلِ اطلاع‌رسانی (بازنشانی + خاموشیِ 2FA) می‌فرستد؛ SMTPِ بخشِ ۵.۱۲ همین‌جا هم به کار می‌رود.
